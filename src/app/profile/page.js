              ...
              <div className="mt-8 flex flex-col sm:flex-row sm:justify-between gap-3">
                ...
                <div>
                  <button
                    ...
                    className={`px-6 py-2 text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${
